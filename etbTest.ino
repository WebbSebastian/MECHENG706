...
void loop(void) //main loop
{
  ...
  driveAtDistFromWall(shortFront, shortRear, 8, 8);
  ...
  driveAtDistFromWall(shortFront, shortRear, 18, 174);
  ...
  driveAtDistFromWall(longFront, longRear, 28, 8);
  ...
  driveAtDistFromWall(longFront, longRear, 38, 174);
  ...
  driveAtDistFromWall(longFront, longRear, 48, 8);
